...
- **(*)** Remove duplicates using [removeChild](https://developer.mozilla.org/en-US/docs/Web/API/Node/removeChild) or [remove](https://developer.mozilla.org/en-US/docs/Web/API/Element/remove) (duplicates are items with the same title, [isEqualNode](https://developer.mozilla.org/en-US/docs/Web/API/Node/isEqualNode) might be useful). 
